...
class FdnTankSpicedBase
{
  public:
    ...
    explicit FdnTankSpicedBase(const float sampleRate)
    ...
    void setItdTaps(std::array<std::array<int, ORDER>, 2>& taps)
    {
        m_itdTaps = taps;
  ...
  private:
    ...
    alignas(16) std::array<std::array<int, ORDER>, 2> m_itdTaps{};
